...
def welkom():
    ...
    print()
    # keuze =input('voer "v"in om verder te gaan of "x" om te stoppen ') 
    # if keuze == "v":
    #     return 
    # elif keuze == "x":
    #     bye()
...
def invoerFenotypen():
    # print("\033c", end="") # ansi escapecodes om venster leeg te trappen
    print ('voer de fenotypen in die horen bij de verschillende allelen')
    print()
...
def menu(genoVader, genoMoeder,dominantA,recessiefA,dominantB,recessiefB):
    ...
    # print ('"n" voor invoeren van nieuwe kruising met nieuwe genotype, dezelfde fenotypen')
    print ('"o" om opnieuw te beginnen, met een hele nieuwe kruising (nieuwe genotypen, nieuwe genotypen)')
    ...
    # elif menuInput == "n":
    #     vernieuwGenotypeOuders(dominantA,recessiefA,dominantB,recessiefB)
    elif menuInput == "f": 
...
# def vernieuwGenotypeOuders(dominantA,recessiefA,dominantB,recessiefB):
#     print("\033c", end="") # ansi escapecodes om venster leeg te trappen
#     print ("Nieuwe ouders, zelfde fenotypische eigenschappen")
#     print ()
...
# genotype vertalen naar placeholders voor fenotype
