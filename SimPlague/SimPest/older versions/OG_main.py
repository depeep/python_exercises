...
# import sqlite3 #voor snapshot nu eigen module
...
class SimulationEngine:
    ...
    def update(self):
        ...
        # nieuw
        #self.game.snapshot_engine.save(self.game)  # geeft 60 snapshots per seconde!!!!grote DB
        # minder snapshot per seconde naar database met modulo 10 bijvoorbeeld, dus om de 10 stappen
...
class UIController:
    def __init__(self, game):
        ...
        self.slider_rect = pygame.Rect(20, 820, 320, 20)
        self.slider_value = (self.game.sim_speed - 0.1) / 4.9
        self.slider_active = False


        # time slider voor snapshots
        self.time_slider_rect = pygame.Rect(20, 895, 320, 20)
        self.time_slider_value = 0.0  # 0..1
    ...
    def update_time_slider_from_mouse(self, mx):
            ...
            # voorkom onnodig opnieuw laden van dezelfde snapshot
            if snapshot_id == self.last_loaded_snapshot_id:
                return

            # pauzeer simulatie tijdens scrubben
    ...
    def draw_panel(self):
        ...
        # self.game.surface.blit(label, (20, 750))

        # # slider bar
        # pygame.draw.rect(self.game.surface, (80, 80, 80), self.slider_rect)

        # # handle positie
        # handle_x = self.slider_rect.x + int(self.slider_value * self.slider_rect.width)
        # handle_rect = pygame.Rect(handle_x - 5, self.slider_rect.y - 5, 10, 30)
        # pygame.draw.rect(self.game.surface, (200, 200, 200), handle_rect)

        # # waarde tekst
        # speed_txt = self.game.smallFont.render(f"{self.game.sim_speed:.2f}x", True, (255, 255, 255))
        # self.game.surface.blit(speed_txt, (250, 750))

        # snapshots klaarzetten voor timeline-info
        self.available_snapshots = self.game.snapshot_engine.list_snapshots()
...
class SurvivalSim:
    def __init__(self):
        ...
        #snelheid
        self.sim_speed = 1.0   # 0.1 = slow, 1 = normaal, 5 = snel
...
# !!!!! parameters aangepast met behulp van ai om te proberen tot een evenwichtssituatie te komen,maar  dat werkt nog niet.
        ...
        # classes voor de SnapshotEngine
